...
func Test_zec_AddressVerify_Valid(t *testing.T) {

	coin := "zec"
	expect := true

	p2pkhAddress := "tmJZytbfDDL9QygrC5abHPPwWktL7iB8VgG"
...
func Test_zec_AddressVerify_InValid(t *testing.T) {

	coin := "zec"
	expect := false

	p2pkhAddress := "tmJZytbfDDL9QygrC5abHPPwWktL7iB8Vga"
