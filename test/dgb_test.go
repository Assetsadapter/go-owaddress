...
func Test_dgb_AddressVerify_Valid(t *testing.T) {

	coin := "dgb"
	expect := true

	p2pkhAddress := "DAo2HCZgvPTmFxFANdhznfHAX5Pjpg4Kg6"
...
func Test_dgb_AddressVerify_InValid(t *testing.T) {

	coin := "dgb"
	expect := false

	p2pkhAddress := "DAo2HCZgvPTmFxFANdhznfHAX5Pjpg4Kgg"
